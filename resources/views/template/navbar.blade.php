<header>
    ...
    <div class="nav-main d-flex flex-column">
        <div class="nav-menu-container container">
            ...
            <div class="nav-menu py-2"><a href="">ARTICLE</a></div>
            <div class="nav-menu py-2"><a href="">CREWS</a></div>
            <div class="nav-menu py-2"><a href="">ABOUT</a></div>
            <div class="nav-menu py-2"><a href="">TVON AIR 7.0</a></div>
        </div>
    </div>
